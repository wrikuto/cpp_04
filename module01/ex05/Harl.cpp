...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/25 16:27:24 by wrikuto           #+#    #+#             */
/*   Updated: 2024/02/26 11:49:57 by wrikuto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	func_Harl 	func[] = {&Harl::debug, &Harl::info, &Harl::warning, &Harl::error};
	std::string	type[] = {"DEBUG", "INFO", "WARNING", "ERROR"};
	size_t		i = 0;

	while(i < 4)
	{
		if (type[i].compare(str) == 0)
		{
			(this->*func[i])();
			break;
		}
